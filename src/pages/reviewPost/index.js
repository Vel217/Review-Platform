...
function Item({
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 py-5 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
        <div className="lg:grid lg:grid-cols-3 lg:items-start lg:gap-x-8 px-5">
          ...
          <div className=" lg:col-span-2 mt-10 px-5  sm:mt-16 sm:px-0 lg:mt-0">
                ...
                <div className="flex gap-5">
                  {session?.user.name !== postContent.author.name ? (
                    <button
                      type="button"
                      onClick={() => deletePost}
                      className="rounded bg-red-400 px-2 py-1 lg:px-3.5 lg:py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-red-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-400"
                    >
                      {t("comments:delete")}
                    </button>
                  ) : null}
                  {session?.user.name !== postContent.author.name ? (
                    <button
                      ...
                      className="rounded bg-teal-400 px-2 py-1 lg:px-3.5 lg:py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-teal-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-400"
                    >
                      {t("comments:edit")}
                    </button>
                  ) : null}
            ...
            <div className="mt-3">
              <div className="text-xl tracking-tight text-gray-900 flex flex-col lg:flex gap-7 ">
                <div> {postContent.film.title}</div>
                <div>
                  {t("comments:assessment")}: {postContent.stars}/10
                </div>
                <div>{format(new Date(postContent.createdAt), "dd/MM/yy")}</div>
      ...
      <div className=" max-w-2xl w-full mx-auto lg:max-w-4xl ">
