  ...
  return (
    <>
      ...
      <div className="flex  w-full  justify-center bg-white">
        <div className="fixed top-100 h-5  right-2 z-50 flex justify-between w-fit p-4 border border-gray-500 rounded-md bg-white dark:bg-gray-700 dark:border-gray-600">
          <div class="flex items-center mx-auto">
            <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
              <Link href="/newReview">new review</Link>
            </p>
          </div>
        </div>
